...
### :dart: 목표 : Spring MVC 패턴을 이용한 계층형 게시판 구현

#### :pencil: 사용자가 게시물을 작성할 수 있고 게시물에 대한 답글을 달 수 있는 게시판 만들기

#### :pencil: KakaoPay API 사용한 간편 단건 결제 구현하기
...
6. 수정 후 홈으로 돌아가면 수정된 것을 확인할 수 있다
